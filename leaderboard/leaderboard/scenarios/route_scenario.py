...
class RouteScenario(BasicScenario):
    ...
    def _update_ego_vehicle(self):
        ...
        ego_vehicle = CarlaDataProvider.request_new_actor(VEHICLE_MODEL, elevate_transform, rolename="hero")
    ...
    def _build_scenario_instances(self, world, ego_vehicle, scenario_definitions, scenarios_per_tick=5, timeout=300, debug_mode=False):
        ...
        for scenario_number, definition in enumerate(scenario_definitions):
            ...
            scenario_configuration.ego_vehicles = [ActorConfigurationData(VEHICLE_MODEL, ego_vehicle.get_transform(), "hero")]
